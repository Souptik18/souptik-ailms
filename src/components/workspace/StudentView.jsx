...
function StudentView({
  ...
  const [analyticsChartsReady, setAnalyticsChartsReady] = useState(false)
  const analyticsRef = useRef(null)
  const analyticsChartGridRef = useRef(null)
  ...
  useEffect(() => {
    ...
    const observer = new window.ResizeObserver((entries) => {
      ...
      setAnalyticsChartsReady(width > 0 && height > 0)
    })

    if (analyticsChartGridRef.current) {
      observer.observe(analyticsChartGridRef.current)
    }
  ...
  return (
    <div className={`${styles.studentShell} ${isMyLearningsTab ? styles.studentShellWide : ''}`} data-tour="student-workspace-content">
      {isRoadmapTab ? (
        <section className={styles.roadmapPanel} data-tour="student-roadmap-panel">
          <header className={styles.roadmapHeader} data-tour="student-roadmap-header">
            <div>
            ...
            <div className={styles.roadmapActions} data-tour="student-roadmap-actions">
          ...
          <div className={styles.roadmapTimeline} data-tour="student-roadmap-timeline">
      ...
      {isReportTab ? (
        <section className={styles.studentAnalytics} ref={analyticsRef} data-tour="student-report-panel">
          <header className={styles.analyticsHeader} data-tour="student-report-header">
            <div>
              <span>Student dashboard</span>
              <h2>Learning Analytics</h2>
              <p>Track progress, market readiness, and AI-powered learning insights.</p>
            </div>
            <div className={styles.analyticsActions} data-tour="student-report-export">
          ...
          <div className={styles.analyticsKpiGrid} data-tour="student-report-kpis">
          ...
          <div className={styles.analyticsChartGrid} data-tour="student-report-charts" ref={analyticsChartGridRef}>
      ...
      {isAssessmentsTab ? (
        <section className={styles.assessmentPanel} data-tour="student-assessments-panel">
          <header className={styles.assessmentHeader} data-tour="student-assessments-header">
            <div>
              <span>Student workspace</span>
              <h2>Assessments</h2>
              <p>Practice tests, quizzes, MCQs, and role-calibrated job readiness exams.</p>
            </div>
            <div className={styles.assessmentModeSwitch} role="tablist" aria-label="Assessment view mode" data-tour="student-assessments-mode">
              <button
                type="button"
          ...
          <div className={styles.assessmentCounterGrid} data-tour="student-assessments-counters">
      ...
      {isInterviewsTab ? (
        <section className={styles.interviewPanel} data-tour="student-interviews-panel">
          <header className={styles.assessmentHeader} data-tour="student-interviews-header">
            <div>
              <span>Student workspace</span>
              <h2>Interviews</h2>
          ...
          <div className={styles.interviewGrid} data-tour="student-interviews-grid">
      ...
      {isMyLearningsTab ? (
        <section className={styles.learningDashboard} data-tour="student-learnings-panel">
          <header className={styles.learningDashboardHeader} data-tour="student-learnings-header">
            <div>
              <span>Student workspace</span>
              <h2>My Learnings</h2>
              <p>Track enrolled items with focused filtering and cleaner course cards built for quick scanning.</p>
            </div>
            <div className={styles.learningToolbar} data-tour="student-learnings-toolbar">
          ...
          <div className={styles.filterPills} data-tour="student-learnings-filters">
            <button
              type="button"
          ...
          {visibleLearningItems.length > 0 ? (
            <div className={styles.dashboardCourseGrid} data-tour="student-learnings-grid">
            ...
            <article className={styles.emptyDashboardState} data-tour="student-learnings-grid">
              <span>No match</span>
      ...
      {isProfileTab ? (
        <section className={styles.profilePanel} data-tour="student-profile-panel">
          <header className={styles.profileHeader} data-tour="student-profile-header">
          ...
          <div className={styles.profileGrid} data-tour="student-profile-grid">
      ...
      {isSettingsTab ? (
        <section className={styles.settingsPanel} data-tour="student-settings-panel">
          <header className={styles.settingsHeader} data-tour="student-settings-header">
            <span>Account controls</span>
            <h2>Settings</h2>
            <p>Choose how you receive course and job notifications.</p>
          </header>
          <div className={styles.settingsList} data-tour="student-settings-list">
      ...
      {isFaqTab ? (
        <section className={styles.faqPanel} data-tour="student-faq-panel">
          <header className={styles.faqHeader} data-tour="student-faq-header">
            <span>Student support</span>
            <h2>FAQ</h2>
            <p>Workspace guidance for roadmap, assessments, interviews, and learning access.</p>
          </header>
          <div className={styles.faqList} data-tour="student-faq-list">

...
function App() {
  ...
  const completePublicSession = useCallback((sessionResponse, mode = 'login') => {
    ...
    const savedOnboarding = nextUser.role === 'student' ? readStudentOnboarding(nextUser.uid) : null
    ...
    if (nextUser.role === 'student' && mode === 'signup') {
      navigate('/course-list', { replace: true })
      return
    }

    if (nextUser.role === 'student' && mode === 'login') {
      navigate(STUDENT_WORKSPACE_PATH, { replace: true })
      return
    }
